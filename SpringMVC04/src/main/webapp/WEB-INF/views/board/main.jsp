  ...
  $(document).ready(function(){
  	...
  	function makeView(data){ // data=[{idx:1,title:"하하",...},{},{},..]
  		...
  		$.each(data, function(index, obj){
	  		listHtml+="<tr align='center' class='table-light hover'>";
	  		...
	  		// 상세 게시글 보여주기
	  		listHtml += "<tr id='c" + obj.idx + "' style='display: none;' class='table-light''>";
	  		listHtml += "<td>내용</td>";
	  		...
	  		//수정, 삭제 버튼 만들기
	  		if(("${mvo.memId}" == obj.memId )|| ("${mvo.memId}" == "admin" )){ 	
	  			...
	  			listHtml += "<span id='up"+obj.idx+"'><button disabled class='btn btn-success' onclick='goUpdateForm(" + obj.idx + ")'>수정</button></span> &nbsp"
	  			listHtml += "<span id='de"+obj.idx+"'><button disabled class='btn btn-warning' onclick='goDelete(" + obj.idx + ")'>삭제</button></span> "
 		...
 		// 글쓰기 버튼 추가
 		if(${not empty mvo}){ 					
	 		listHtml+='<tr align="right" class="table-light"><td colspan="5">';
...
<div class="container text-white text-center"  style= "background-color:#6495ED">
  <h2>SpringMVC03</h2>
  <div class="cotainer mt-3 ">
    <div class="cotainer mt-3"><h3>Board</h3></div>
    <!-- 전체 게시글 조회 -->
    <div class="cotainer mt-3" id="view">
 
    </div>
    
    <!-- 글쓰기 폼 -->
	<div class="cotainer mt-3" style="display: none;" id="wform">
	<form id="frm">
